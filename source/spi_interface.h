...
#define RAD_SPI_SCLK       					CYBSP_RSPI_CLK
#define RAD_SPI_MOSI       					CYBSP_RSPI_MOSI
#define RAD_SPI_MISO       					CYBSP_RSPI_MISO
#define RAD_SPI_CSN        					CYBSP_RSPI_CS
#define RAD_RSTN           					CYBSP_RXRES_L
